...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
        ...
        <xsl:for-each select="$input-uris">
            ...
            <xsl:choose>
                ...
                <xsl:otherwise>
                    ...
                    <xsl:call-template name="transform-uri">
    ...
    <xsl:template name="transform" visibility="public">
    ...
    <xsl:template name="transform-uri" as="empty-sequence()" visibility="public">
    ...
    <xsl:template name="transform-with-manifest" visibility="public">
        <xsl:param name="input" as="node()" required="yes"/>
        <xsl:param name="manifest-uri" as="xs:anyURI" required="yes"/>
        <xsl:param name="debug-dir-uri" as="xs:anyURI" required="yes"/>
        <xsl:param name="verbose" as="xs:boolean?"/>
    ...
    <xsl:template name="transform-uri-with-manifest" as="empty-sequence()" visibility="public">
        <xsl:param name="input-uri" as="xs:anyURI" required="yes"/>
        <xsl:param name="output-uri" as="xs:anyURI" required="yes"/>
        <xsl:param name="manifest-uri" as="xs:anyURI" required="yes"/>
        <xsl:param name="debug-dir-uri" as="xs:anyURI" required="yes"/>
